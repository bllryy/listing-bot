...
from bot.util.calcs import *
from bot.util.fetch import fetch_mojang_api, fetch_profile_data
...
def create_embed(
        ...
        profile_type: str, bot: discord.ext.commands.Bot,
        coop: bool,
        uuid: str = None,
...
class ToggleView(discord.ui.View):
    ...
    async def toggle_value_type(self, interaction: discord.Interaction, return_embed: bool = False):
        if self.value_type == "Value":
            ...
            self.value_data = {
                key: self.original_data.get(key, 0) * 1.8
                for key in self.original_data
            }
